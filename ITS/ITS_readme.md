...
3. [Import ITS data](#step1-import-its-data)
4. [Quality controlling sequences and building Feature Table and Feature Data](#step2-quality-controlling-sequences-and-building-feature-table-and-feature-data)
5. [Summarizing Feature Table and Feature Data](#step-3-summarizing-feature-table-and-feature-data)
6. [Taxonomy assignment](#step-4-taxonomy-assignment)
...
His average length in Fungi si about 615nt so actually is not possible to sequence it completely by using Illumina sequencing.  
...
Since the differences mainly concern steps required to properly prepare your raw data we will focus only on two soil samples.  
